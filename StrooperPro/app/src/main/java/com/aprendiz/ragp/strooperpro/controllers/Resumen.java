...
public class Resumen extends AppCompatActivity implements View.OnClickListener{
    ...
    public void inputBaseData(){
        ...
        if (JuegoC.NoData!=1) {
            ...
            score.setCorrectas(Integer.toString(JuegoC.ccorrecto));
            score.setPorcentaje(Integer.toString(JuegoC.caciertos));
            Toast.makeText(this, "Resultados del juego personalizado", Toast.LENGTH_SHORT).show();
        }
    }
